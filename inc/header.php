...
<nav id="nav-bar" class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
    <div class="container-fluid">
        <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="index.php">METRO HOTEL</a>
        ...
        <div class="modal-content">
            <form id="login-form">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label class="form-label">Email эсвэл Утас</label>
            ...
            <form id="register-form">
                ...
                <div class="modal-body">
                    <span class="badge bg-secondary mb-3 text-wrap lh-base">
                        Жич: Таны мэдээлэл таны иргэний үнэмлэхтэй тохирч байх ёстой.
                    </span>
                    <div class="container-fluid">
                        <div class="row">
