<div class="container-fluid bg-white mt-5">
    ...
    function alert(type,msg,position='body')
    {
        ...
        register_form.addEventListener('submit', (e)=>{
            ...
            xhr.open("POST","/metroHotel/ajax/login_register.php", true);
            ...
            xhr.onload = function(){
              if(this.responseText == 'pass_mismatch'){
                ...
                alert('error',"PhoneNumber Already Registered!");
              }
                ...
                alert('success',"Registration Succesful! Confirmation link sent to email.");
                register_form.reset();
              }             
            }
